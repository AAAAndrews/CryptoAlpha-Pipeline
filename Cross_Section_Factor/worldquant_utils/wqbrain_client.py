...
class BrainBatchAlpha:
    ...
    def _simulate_single_alpha(self, alpha, max_retries=3, max_simulation_time=600):
            ...
            try:
                ...
                if sim_resp.status_code != 201:
                    if sim_resp.status_code in [401, 403]:
                        ...
                        print("⚠️ alphaThe simulation is queuing, please wait for the prequel to be completed.")
                        sleep(300)
                        continue
    ...
    def check_alpha_qualification(self, alpha_data):
        ...
        try:
            ...
            if sharpe < 1.5 or fitness < 1.0 or (turnover < 0.1 or turnover > 0.9) or \
                ic_mean < 0.02 or subuniverse_sharpe < required_subuniverse_sharpe:
                is_qualified = False
