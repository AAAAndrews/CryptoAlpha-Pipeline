...
class BinanceBulkDownloader:
    ...
    def __init__(
        ...
        :param proxy: Optional. Proxy settings for requests (e.g., {'http': 'http://proxy.com:8080', 'https': 'https://proxy.com:8080'})
        """
    ...
    def _get_file_list_from_s3_bucket(self, prefix):
        ...
        with Live(refresh_per_second=4) as live:
            ...
            while is_truncated:
                ...
                response = requests.get(self._BINANCE_DATA_S3_BUCKET_URL, params=params, proxies=self._proxy)
